    ...
    static function prepare() {
     ...
     // hook so we can add menus to our admin left-hand menu
            ...
            static function add_my_admin_menus(){
                ...
                $my_page_6 = add_submenu_page ('promo-nft-admin',__( 'Changelog', 'promo-nft' ),__( 'Changelog', 'promo-nft'),'manage_options', 'changelog', array( 'PromoNft_AdminController', 'nftChangelog'));
    ...
    static function getNrOfCollectionNetworks(){
        ...
        * The main menu page
         */
            ...
            static function nftChangelog()
            {
                include PROMO_NFT_PLUGIN_ADMIN_VIEWS_DIR . '/changelog.php';
            }
    }
?>